...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class ExternalController : Controller
    {
        ...
        private readonly SignInManager<MonsterUser> _signInManager;
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            //await HttpContext.SignInAsync(provider, localSignInProps);
        ...
        private async Task<(MonsterUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<MonsterUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
